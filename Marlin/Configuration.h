...
#define STRING_CONFIG_H_AUTHOR "(DigitalWhitewater, 101Hero Pylon)" // Who made the changes.
...
#ifndef MOTHERBOARD
  //I copied what will likely be the most common boards used. All boards are defined in "Boards.h" //DigitalWhitewater
  //#define MOTHERBOARD BOARD_RAMPS_13_EFB  // RAMPS 1.3 / 1.4 (Power outputs: Extruder, Fan, Bed)
  //#define MOTHERBOARD BOARD_RAMPS_13_EFF  // RAMPS 1.3 / 1.4 (Power outputs: Extruder, Fan, Fan)
  #define MOTHERBOARD BOARD_RUMBA         // Rumba
#endif

// Define this to set a custom name for your generic Mendel,
// #define CUSTOM_MENDEL_NAME "101Hero Pylon"
...
#define DELTA_SMOOTH_ROD_OFFSET 23.0 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 115.0 // mm
